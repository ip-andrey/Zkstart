...
# from tools.helpers import remove_wallet
from tools.sleeping import sleep
...
def main(module):
    ...
    with ThreadPoolExecutor(max_workers=QUANTITY_THREADS) as executor:
        ...
        with open("made_wallets.txt", "a") as file:
            file.write(f"{account.get('id')} | {account.get('key')} | {account.get('proxy')}\n")
