...
with open('info/rpc.json') as file:
    RPC = json.load(file)

with open('info/abi/erc20_abi.json') as file:
...
with open('info/abi/zksync/deposit.json') as file:
    ZKSYNC_DEPOSIT_ABI = json.load(file)

with open('info/abi/zksync/withdraw.json') as file:
    ZKSYNC_WITHDRAW_ABI = json.load(file)

with open('info/abi/zksync/weth.json') as file:
    WETH_ABI = json.load(file)

with open("info/abi/syncswap/router.json", "r") as file:
    SYNCSWAP_ROUTER_ABI = json.load(file)

with open('info/abi/syncswap/classic_pool.json') as file:
    SYNCSWAP_CLASSIC_POOL_ABI = json.load(file)

with open('info/abi/syncswap/classic_pool_data.json') as file:
    SYNCSWAP_CLASSIC_POOL_DATA_ABI = json.load(file)

with open("info/abi/mute/router.json", "r") as file:
    MUTE_ROUTER_ABI = json.load(file)

with open("info/abi/spacefi/router.json", "r") as file:
    SPACEFI_ROUTER_ABI = json.load(file)

with open("info/abi/pancake/router.json", "r") as file:
    PANCAKE_ROUTER_ABI = json.load(file)

with open("info/abi/pancake/factory.json", "r") as file:
    PANCAKE_FACTORY_ABI = json.load(file)

with open("info/abi/pancake/quoter.json", "r") as file:
    PANCAKE_QUOTER_ABI = json.load(file)

with open("info/abi/woofi/router.json", "r") as file:
    WOOFI_ROUTER_ABI = json.load(file)

with open("info/abi/zkswap/router.json", "r") as file:
    ZKSWAP_ROUTER_ABI = json.load(file)

with open("info/abi/maverick/position.json", "r") as file:
    MAVERICK_POSITION_ABI = json.load(file)

with open("info/abi/maverick/router.json", "r") as file:
    MAVERICK_ROUTER_ABI = json.load(file)

with open("info/abi/vesync/router.json", "r") as file:
    VESYNC_ROUTER_ABI = json.load(file)

with open("info/abi/bungee/abi.json", "r") as file:
    BUNGEE_ABI = json.load(file)

with open("info/abi/stargate/router.json", "r") as file:
    STARGATE_ABI = json.load(file)

with open("info/abi/eralend/abi.json", "r") as file:
    ERALEND_ABI = json.load(file)

with open("info/abi/basilisk/abi.json", "r") as file:
    BASILISK_ABI = json.load(file)

with open("info/abi/reactorfusion/abi.json", "r") as file:
    REACTORFUSION_ABI = json.load(file)

with open("info/abi/zerolend/abi.json", "r") as file:
    ZEROLEND_ABI = json.load(file)

with open("info/abi/dmail/abi.json", "r") as file:
    DMAIL_ABI = json.load(file)

with open("info/abi/l2telegraph/send_message.json", "r") as file:
    L2TELEGRAPH_MESSAGE_ABI = json.load(file)

with open("info/abi/l2telegraph/bridge_nft.json", "r") as file:
    L2TELEGRAPH_NFT_ABI = json.load(file)

with open("info/abi/nft2me/abi.json", "r") as file:
    MINTER_ABI = json.load(file)

with open("info/abi/mailzero/abi.json", "r") as file:
    MAILZERO_ABI = json.load(file)

with open("info/abi/tavaera/id.json", "r") as file:
    TAVAERA_ID_ABI = json.load(file)

with open("info/abi/tavaera/abi.json", "r") as file:
    TAVAERA_ABI = json.load(file)

with open("info/abi/zks/abi.json", "r") as file:
    ZKS_ABI = json.load(file)

with open("info/abi/era_ns/abi.json", "r") as file:
    ENS_ABI = json.load(file)

with open("info/abi/omnisea/abi.json", "r") as file:
    OMNISEA_ABI = json.load(file)

with open("info/abi/gnosis/abi.json", "r") as file:
    SAFE_ABI = json.load(file)

with open("info/abi/zkstars/abi.json", "r") as file:
...
# CONTRACT_PATH = Path("info/deploy/Token.json")
